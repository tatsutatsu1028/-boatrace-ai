...
# v1.10.7 mobile fixed deadline button grid
st.markdown("""
<style>
...
with tab1:
    ...
    # スマホでも4列×3段を固定しつつ、表示そのものをタップ可能にする。
    # Streamlit標準buttonを4列×3段で使い、重複していた「見た目用カード」は廃止。
    st.markdown(
        """
        <style>
        div[class*="st-key-deadline_button_row_"] [data-testid="stHorizontalBlock"]{
    ...
    for rr in near_deadline:
        st.markdown(
            f"""
            <style>
            .st-key-race_deadline_btn_{rr} button p {{

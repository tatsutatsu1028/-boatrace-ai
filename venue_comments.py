...
TSU_COMMENT_PAGES = (
    # 2026年前半のサイトリニューアルで page=yosou-yosou は廃止された。
    # 現行の共通CMS（からつ・住之江等と同系列）に合わせて更新。
    "https://www.boatrace-tsu.com/sp/index.php?page=raceinfo-racers_comment",
    # 念のため旧URLも最後にフォールバックとして試す。
